...
import { createGrado, UpdateGrado } from './grado.dto';
import GradosCM from './grado.CM';
import HttpException from '../../exceptions/HttpException';


class GradoController implements Controller{
    public router = Router();
    public path = '/grado';
    private UserCM = new GradosCM();
    ...
    initializeRoutes() {
        this.router.post(this.path + '/new',validationMiddleware(createGrado, true), this.CreaterUser);
